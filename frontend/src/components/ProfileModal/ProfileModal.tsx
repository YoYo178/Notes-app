      ...
      <div className='pm' onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className='pm-fields'>
          <div className='pm-field-username-container'>
            <label htmlFor='pm-username-field' className='pm-field-username-label'>
              Username
            </label>
            <input
              type='text'
          ...
          <div className='pm-field-display-name-container'>
            <label htmlFor='pm-display-name-field' className='pm-field-display-name-label'>
              Display name
            </label>
            <input
              type='text'
          ...
          <div className='pm-field-email-container'>
            <label htmlFor='pm-email-field' className='pm-field-email-label'>
              Email
            </label>
            <input
              type='email'
          ...
          <div className='pm-field-password-container'>
            <div className='pm-field-current-password-container'>
              <label
                htmlFor='pm-current-password-field'
                className='pm-field-current-password-label'
              >
                Current password
              </label>
              <input
            ...
            <div className='pm-field-new-password-container'>
              <label htmlFor='pm-new-password-field' className='pm-field-username-label'>
                New password
              </label>
              <input
                type='password'
            ...
            <div className='pm-field-confirm-new-password-container'>
              <label htmlFor='pm-confirm-new-password-field' className='pm-field-username-label'>
        ...
        <div className='pm-footer'>
          <div className='pm-field-id-container'>
            <label htmlFor='pm-id-field' className='pm-field-id-label'>
              ID:
            </label>
            <p id='pm-id-field' className='pm-field-id'>
              {auth?.id}
            </p>
          </div>
          <button
            className='pm-delete-acc-button'
            onClick={() => {
              ButtonHandler.deleteAccButtonOnClick(deleteUserMutation);
            }}
          >
            <FaTrashAlt />
          ...
          <button
            className='pm-check-button'
            onClick={() => {
              const res = ButtonHandler.profileModalOnSubmit(updateUserMutation, auth, {
                displayName,
                email,
                currentPassword,
                newPassword,
