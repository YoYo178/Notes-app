...
export const SortDropdownMenu: FC<SortDropdownMenuProps> = ({
  sortButtonRef,
  isOpen,
  onClose,
  sortOrder,
  ...
  return (
    <ul
      className={`sort-dropdown-menu ${isOpen ? 'visible' : 'hidden'}`}
        ...
        return (
          <Fragment key={'dmo-f-' + i}>
            ...
            >
              ...
              <li key={'dmo-c-option' + i} className='sort-dropdown-option'>
                {optionTitle}
              </li>
            </div>
