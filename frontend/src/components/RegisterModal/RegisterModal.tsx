...
function mutationCallbackHandler(
  ...
  if (mutation.isSuccess && mutation.data) {
    setCurrentStage((prev) => {
      if (prev === RegisterStages.REDIRECT) return prev;
...
export const RegisterModal: FC = () => {
  ...
  return (
    <form
      ...
      onKeyDown={(e) => EventHandler.onKeyDown(e, buttonRef)}
    >
        ...
        <>
          ...
          <div className='rm-field-container'>
            ...
            <div className='rm-toggle-password-container'>
              <button
                className='rm-toggle-password-button'
        ...
        <>
          <div className='rm-verification-text'>
            ...
            {!!emailLink && (
              <>
                <span>
                  Note: This project currently uses Ethereal, which is a Fake email service.
                </span>
                <span>
                  Click{' '}
          ...
          <div className='rm-resend-code-container'>
            <button
              ...
              onClick={() =>
                resendTime < 1 &&
                ButtonHandler.resendCodeOnClick(timerRef, setResendTime, resendCodeMutation, userID)
              }
      ...
      <div className='rm-error' style={{ display: errorMessage.length ? 'block' : 'none' }}>
        {errorMessage}
      </div>
      <div className='rm-info' style={{ display: successMessage.length ? 'block' : 'none' }}>
        {successMessage}
      </div>
      ...
      {currentStage !== RegisterStages.REDIRECT && (
        <>
          ...
          <div className='rm-existing-acc-container'>
            ...
            <Link to='/login' className='rm-existing-acc-button' state={{ from: location }} replace>
              Sign-In
            </Link>
          </div>
        </>
