        ...
        {isRecording && (
          <div className='sidebar-recording-container'>
            <div className='sidebar-recording-indicator'>
              ...
              <span className='sidebar-recording-text'>
                Recording... ({MAX_AUDIO_RECORD_DURATION - (recordingTime || 0)}s)
              </span>
            </div>
            {!hasSpeechRecognitionSupport ? (
              <div className='sidebar-live-transcript-not-supported-container'>
                ...
                <span className='sidebar-live-transcript-not-supported'>
                  Your browser does not support Speech Recognition.
                </span>
              </div>
            ) : (
              transcript && <div className='sidebar-live-transcript-text'>{transcript}</div>
            )}
          </div>
        )}

        {!!auth ? <SidebarUser displayName={auth?.displayName} /> : <SidebarLogin />}
      </nav>
