    ...
    <div className='sidebar-user'>
      ...
      <div ref={sidebarItemsRef} className='sidebar-user-items'>
        <p
          ...
          onClick={() =>
            ButtonHandler.dropdownButtonOnClick(setAngle, angle, setIsDropdownMenuVisible)
          }
        >
          {displayName}
        </p>
        <button
          className='sidebar-user-dropdown-button'
          onClick={() =>
            ButtonHandler.dropdownButtonOnClick(setAngle, angle, setIsDropdownMenuVisible)
          }
        >
          <ul
            className={`sidebar-dropdown-menu ${isDropdownMenuVisible ? 'visible' : 'hidden'}`}
            ...
            {dropdownMenuArr.map((pair, i) => {
              ...
              return (
                <Fragment key={'dmo-f-' + i}>
                  <li
                    key={'dmo-' + i}
                    className='sidebar-user-dropdown-option'
                    onClick={() =>
                      optionCallbackFn({
                        logoutMutation,
                        isProfileModalOpen,
