...
export const LoginModal: FC = () => {
  ...
  return (
    <form
      ...
      onKeyDown={(e) => ButtonHandler.onKeyDown(e, username, password, loginMutation)}
    >
      ...
      <Link to='/reset' className='forgot-password-button'>
        Forgot password?
      </Link>

      <div className='lm-error' style={{ display: errorMessage.length ? 'block' : 'none' }}>
        {errorMessage}
      </div>
      ...
      <div className='register-container'>
        ...
        <Link
          to='/register'
          className='login-modal-register-button'
          state={{ from: location }}
          replace
        >
          Register now
